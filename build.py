...
class CustomPlacer(OdbpyStep):

	id = "TT.Top.CustomPlacer"
	name = "Custom Placer for LISA"
...
if __name__ == '__main__':
   ...
   #ProjectFlow.Steps.insert(ProjectFlow.Steps.index(OpenROAD.GlobalPlacementSkipIO), CustomPlacer)
